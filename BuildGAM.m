function models = BuildGAM(xt,yt,dt,binrange,nbins,nfolds,filtwidth,modelname)
...
for n = 1:nModels
    ...
    if strcmp(modelname,'LNP')
        [models.testFit{n},models.trainFit{n},models.wts{n}] = FitModel(X{n},yt,dt,h,Model{n},nfolds);
    end
end
